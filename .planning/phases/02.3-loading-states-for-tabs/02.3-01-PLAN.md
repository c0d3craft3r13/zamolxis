...
5. Update any other references from `conversations` to `chatsState.conversations` in the file.
  ...
  <verify>
- Build succeeds: `cd /home/tyler/repos/public/zamolxis && JAVA_HOME=/home/tyler/android-studio/jbr ./gradlew :app:compileDebugKotlin`
...
1. **Build verification:**
   ```bash
   cd /home/tyler/repos/public/zamolxis
