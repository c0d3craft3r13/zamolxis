...
depends_on: ["01-02"]
files_modified:
  - app/src/main/java/network.zamolxis.app/ZamolxisApplication.kt
  - app/src/main/java/network.zamolxis.app/MainActivity.kt
autonomous: true
...
must_haves:
  ...
  artifacts:
    - path: "app/src/main/java/network.zamolxis.app/ZamolxisApplication.kt"
      provides: "Sentry performance monitoring initialization"
      contains: "enableTracing"
    - path: "app/src/main/java/network.zamolxis.app/MainActivity.kt"
      provides: "JankStats integration for frame monitoring"
      contains: "JankStats"
  key_links:
    - from: "ZamolxisApplication.kt"
      to: "Sentry SDK"
...
<task type="auto">
  ...
  <files>app/src/main/java/network.zamolxis.app/ZamolxisApplication.kt</files>
  <action>
...
1. Locate the Sentry initialization in ZamolxisApplication.kt (likely in onCreate or a CrashReportManager).
...
<task type="auto">
  ...
  <files>app/src/main/java/network.zamolxis.app/MainActivity.kt, app/build.gradle.kts</files>
  <action>
