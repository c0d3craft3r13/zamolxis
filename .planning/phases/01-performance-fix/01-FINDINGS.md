...
- `reticulum/src/main/java/network.zamolxis.app/reticulum/python/PythonWrapperManager.kt` (Chaquopy lifecycle)
...
**Files to investigate:**
- `app/src/main/java/network.zamolxis.app/ui/announce/AnnounceStreamScreen.kt`
- `app/src/main/java/network.zamolxis.app/viewmodel/AnnounceStreamViewModel.kt`
...
- `reticulum/src/main/java/network.zamolxis.app/reticulum/python/PythonWrapperManager.kt`
