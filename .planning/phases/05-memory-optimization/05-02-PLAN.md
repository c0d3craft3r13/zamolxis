...
must_haves:
  ...
  artifacts:
    ...
    - path: "app/src/main/java/network.zamolxis.app/service/manager/PythonWrapperManager.kt"
...
IMPORTANT per CONTEXT.md: "Triple-check before concluding Reticulum itself has a memory leak" - if leak appears to be in RNS/LXMF code, verify with upstream Reticulum (not Zamolxis fork) first.
...
<task type="auto">
  ...
  <files>app/src/main/java/network.zamolxis.app/service/manager/PythonWrapperManager.kt</files>
  <action>
