...
- `data/src/test/java/network.zamolxis.app/data/db/dao/AnnounceDaoTest.kt` - Added 6 tests for SQL subquery behavior, helper functions for test entities with FK constraints
- `app/src/test/java/network.zamolxis.app/viewmodel/AnnounceStreamViewModelTest.kt` - Updated 2 tests, added 1 new test for identity-aware delete routing
...
- Coverage: Dedicated test verifies identity_A has no contacts → all announces deleted
