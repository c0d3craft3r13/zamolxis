...
depends_on: ["02.1-01"]
files_modified:
  - data/src/test/java/network.zamolxis.app/data/db/dao/AnnounceDaoTest.kt
  - app/src/test/java/network.zamolxis.app/viewmodel/AnnounceStreamViewModelTest.kt
autonomous: true
...
must_haves:
  ...
  artifacts:
    - path: "data/src/test/java/network.zamolxis.app/data/db/dao/AnnounceDaoTest.kt"
      provides: "DAO-level tests for deleteAllAnnouncesExceptContacts SQL query"
      contains: "deleteAllAnnouncesExceptContacts"
    - path: "app/src/test/java/network.zamolxis.app/viewmodel/AnnounceStreamViewModelTest.kt"
...
@data/src/test/java/network.zamolxis.app/data/db/dao/AnnounceDaoTest.kt
@app/src/test/java/network.zamolxis.app/viewmodel/AnnounceStreamViewModelTest.kt
@data/src/main/java/network.zamolxis.app/data/db/entity/ContactEntity.kt
@data/src/main/java/network.zamolxis.app/data/db/entity/AnnounceEntity.kt
</context>
...
<task type="auto">
  ...
  <action>
    ...
    Add `import network.zamolxis.app.data.db.entity.ContactEntity` to imports.
    Add `import network.zamolxis.app.data.db.entity.LocalIdentityEntity` to imports.
    ...
    **IMPORTANT**: ContactEntity has a foreign key on `identityHash` referencing `local_identities.identityHash`. You MUST insert a `LocalIdentityEntity` first before inserting any contacts, otherwise the FK constraint will fail. Check ZamolxisDatabase for the identity DAO accessor name.
  ...
  <verify>
    Run the DAO tests:
    ```bash
    JAVA_HOME=/home/tyler/android-studio/jbr ./gradlew :data:testDebugUnitTest --tests "network.zamolxis.app.data.db.dao.AnnounceDaoTest"
    ```
...
<task type="auto">
  ...
  <verify>
    ...
    ```bash
    JAVA_HOME=/home/tyler/android-studio/jbr ./gradlew :app:testDebugUnitTest --tests "network.zamolxis.app.viewmodel.AnnounceStreamViewModelTest"
    ```
...
<verification>
1. All DAO tests pass: `JAVA_HOME=/home/tyler/android-studio/jbr ./gradlew :data:testDebugUnitTest --tests "network.zamolxis.app.data.db.dao.AnnounceDaoTest"`
2. All ViewModel tests pass: `JAVA_HOME=/home/tyler/android-studio/jbr ./gradlew :app:testDebugUnitTest --tests "network.zamolxis.app.viewmodel.AnnounceStreamViewModelTest"`
