...
depends_on: ["02.2-01"]
files_modified:
  - app/src/main/java/network.zamolxis.app/map/MapTileSourceManager.kt
  - app/src/main/java/network.zamolxis.app/ui/screens/MapScreen.kt
autonomous: false
...
must_haves:
  ...
  artifacts:
    - path: "app/src/main/java/network.zamolxis.app/map/MapTileSourceManager.kt"
      provides: "MapStyleResult.OfflineWithLocalStyle variant and offline style resolution"
      contains: "OfflineWithLocalStyle"
    - path: "app/src/main/java/network.zamolxis.app/ui/screens/MapScreen.kt"
...
<verification>
1. `cd /home/tyler/repos/public/zamolxis && JAVA_HOME=/home/tyler/android-studio/jbr ./gradlew :app:compileDebugKotlin` succeeds
2. Run existing tests: `cd /home/tyler/repos/public/zamolxis && JAVA_HOME=/home/tyler/android-studio/jbr ./gradlew :app:testDebugUnitTest` passes (no regressions)
