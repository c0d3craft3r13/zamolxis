...
- `app/src/main/java/network.zamolxis.app/service/PropagationNodeManager.kt` - Added loop detection, exponential backoff, and Sentry diagnostics for relay selection
