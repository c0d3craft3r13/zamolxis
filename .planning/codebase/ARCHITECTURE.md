...
- Location: `app/src/main/java/network.zamolxis.app/ui/`
...
- Location: `app/src/main/java/network.zamolxis.app/viewmodel/`
...
- Location: `data/src/main/java/network.zamolxis.app/data/repository/` and `app/src/main/java/network.zamolxis.app/repository/`
...
- Location: `app/src/main/java/network.zamolxis.app/service/`
...
- Location: `data/src/main/java/network.zamolxis.app/data/db/`
...
- Location: `reticulum/src/main/java/network.zamolxis.app/reticulum/`
...
- Location: `reticulum/src/main/java/network.zamolxis.app/reticulum/model/` and `app/src/main/java/network.zamolxis.app/data/model/`
...
1. `ZamolxisApplication.onCreate()` initializes DI and starts core managers
...
- Examples: `reticulum/src/main/java/network.zamolxis.app/reticulum/protocol/ReticulumProtocol.kt`
...
- Examples: `app/src/main/java/network.zamolxis.app/service/binder/ReticulumServiceBinder.kt`
...
- One DAO per entity type in `data/src/main/java/network.zamolxis.app/data/db/dao/`

## Entry Points

**MainActivity:**
- Location: `app/src/main/java/network.zamolxis.app/MainActivity.kt`
...
**ZamolxisApplication:**
- Location: `app/src/main/java/network.zamolxis.app/ZamolxisApplication.kt`
...
**ReticulumService:**
- Location: `app/src/main/java/network.zamolxis.app/service/ReticulumService.kt`
...
- Location: `app/src/main/java/network.zamolxis.app/service/RNodeCompanionService.kt`
- Triggers: Companion Device Manager (Android 12+) when RNode in range
- Responsibilities: Register Zamolxis as companion app for RNode devices
...
- Location: `app/src/main/java/network.zamolxis.app/util/validation/`
