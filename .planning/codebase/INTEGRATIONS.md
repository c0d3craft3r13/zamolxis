...
- Integration: Python library + KotlinBLEBridge at `reticulum/src/main/java/network.zamolxis.app/reticulum/ble/bridge/KotlinBLEBridge.kt`
...
- Usage: `LocationSharingManager` (`app/src/main/java/network.zamolxis.app/service/LocationSharingManager.kt`) and `TelemetryCollectorManager` manage requests
...
- Usage: `MapScreen` at `app/src/main/java/network.zamolxis.app/ui/screens/MapScreen.kt`
...
- `InterfaceDatabase` at `app/src/main/java/network.zamolxis.app/data/database/InterfaceDatabase.kt` - Reticulum interface configs
- Core entities in `data/src/main/java/network.zamolxis.app/data/db/entity/`:
