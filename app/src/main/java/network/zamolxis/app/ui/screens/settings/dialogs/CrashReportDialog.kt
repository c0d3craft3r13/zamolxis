...
fun CrashReportDialog(
    ...
    AlertDialog(
        ...
        title = {
            Text(
                text = stringResource(R.string.crashreport_crashed),
        ...
        text = {
            Column(
                ...
                Text(
                    text = stringResource(R.string.crashreport_body),
                ...
                // Crash details
                Text(
                    text = stringResource(R.string.crashreport_exception, exceptionName),
                ...
                Text(
                    text = stringResource(R.string.crashreport_time, crashTime),
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant,
                )
                ...
                Text(
                    text = stringResource(R.string.crashreport_include_note),
