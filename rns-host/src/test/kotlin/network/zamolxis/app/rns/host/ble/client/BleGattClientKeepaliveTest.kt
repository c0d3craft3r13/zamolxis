...
class BleGattClientKeepaliveTest {
    ...
    private fun createConnectionData(address: String): Any {
        ...
        // Note: Kotlin data classes with default values generate a synthetic `$default` constructor
        // (params + Int bitmask + DefaultConstructorMarker) alongside the primary; pick the
        // primary one by arity to avoid Robolectric/JVM ordering variance picking the synthetic.
        val constructor =
            connectionDataClass.declaredConstructors.first { it.parameterCount == 11 }
